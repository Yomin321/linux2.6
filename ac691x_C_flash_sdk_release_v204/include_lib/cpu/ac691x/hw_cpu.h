...
typedef struct {
    __RW __u8  MASK_CON;
    __WO __u32 UNMASK_ADRH;
    __WO __u32 UNMASK_ADRL;
} JL_OTP_MASK_TypeDef;

#define JL_OTP_MASK_BASE               (hs_base + map_adr(0x03, 0x08))

#define JL_OTP_MASK                    ((JL_OTP_MASK_TypeDef			*)JL_OTP_MASK_BASE)
...
#define JL_CTM_BASE                  		(ls_base + map_adr(0x12, 0x00))

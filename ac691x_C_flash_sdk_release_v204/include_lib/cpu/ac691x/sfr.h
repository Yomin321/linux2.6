...
#define OTP_MASK_CON                  (*(__RW __u8  *)(hs_base + map_adr(0x03, 0x08)))
#define OTP_UNMASK_ADRH               (*(__RW __u32 *)(hs_base + map_adr(0x03, 0x09)))
#define OTP_UNMASK_ADRL               (*(__RW __u32 *)(hs_base + map_adr(0x03, 0x0a)))
//
//
...
#define OTPCMD0                       (*(__RW __u16 *)(ls_base + map_adr(0x0f, 0x02)))
#define OTPCMD1                       (*(__WO __u8  *)(ls_base + map_adr(0x0f, 0x03)))
#define OTPCMD2                       (*(__WO __u8  *)(ls_base + map_adr(0x0f, 0x04)))
#define OTPWDAT0                      (*(__RW __u32 *)(ls_base + map_adr(0x0f, 0x05)))
#define OTPWDAT1                      (*(__RW __u32 *)(ls_base + map_adr(0x0f, 0x06)))
#define OTPOPENCNT                    (*(__RW __u32 *)(ls_base + map_adr(0x0f, 0x07)))
#define OTPCLOSECNT                   (*(__RW __u32 *)(ls_base + map_adr(0x0f, 0x08)))

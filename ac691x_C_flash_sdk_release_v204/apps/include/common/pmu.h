...
//
//===============================================================================//
#define pmu_csen()      (PMU_CON |= BIT(0))
#define pmu_csdis()     (PMU_CON &= ~BIT(0))
#define pmu_stran()     (PMU_CON |= BIT(5))
#define pmu_swait()     (PMU_CON & BIT(1))

#define pmu_go()        (PMU_CON |= BIT(4))
#define pmu_wto()       (PMU_CON & BIT(7))
...
// {PWVLD, PWDIS, RSTMASK, SWVLD, ALLVLD, ANALVD, CLKVLD, NONVO}
...
#define RD_WLDO12_CON        (0x23)
#define WR_WLDO12_CON        (RD_WLDO12_CON | 0x80)
//


#define RD_ANA_KEEP         (0x24)
#define WR_ANA_KEEP         (RD_ANA_KEEP | 0x80)
//
...
//
//===============================================================================//
#define p33_csen()      (P33_CON |= BIT(0))
#define p33_csdis()     (P33_CON &= ~BIT(0))
#define p33_stran()     (P33_CON |= BIT(5))
#define p33_swait()     (P33_CON & BIT(1))



#define psfr_ana_con0                       0x00
#define psfr_ana_con1                       0x01
#define psfr_ana_con2                       0x02
#define psfr_ana_con3                       0x03
#define psfr_chg_con                        0x04
#define psfr_plvd_con                       0x05
#define psfr_vlvd_con                       0x06
#define psfr_rst_src                        0x07
#define psfr_lrc_con0                       0x08
#define psfr_lrc_con1                       0x09
#define psfr_aux_con0                       0x0a
//
#define psfr_ana_keep                       0x0c
#define psfr_vld_keep                       0x0d
...
//
//===============================================================================//
#define rtc_csen()      (RTC_CON |= BIT(8))
#define rtc_csdis()     (RTC_CON &= ~BIT(8))
#define rtc_stran()     (RTC_CON |= BIT(12))
#define rtc_swait()     (RTC_CON & BIT(9))

...
#ifndef _AC6919A_CONFIG_
#define _AC6919A_CONFIG_
...
#define IO_KEY_PP_POART_SLECT       0//KEY_PORT_PR
///可选配置KEY_PORTR_0~KEY_PORTR_3/ PORT_BIT_0~PORT_BIT_15/ 0
#define IO_KEY_PP_N                 0//KEY_PORTR_2     ///use witch port 做PP按键


///可选配置KEY_PORT_PR/KEY_PORT_DP/KEY_PORT_DM/KEY_POARA/KEY_POARA/KEY_POARB/KEY_POARC/KEY_POARD/ 0
#define IO_KEY_NEXT_POART_SLECT     0//KEY_PORT_PR
//可选配置KEY_PORTR_0~KEY_PORTR_3/ PORT_BIT_0~PORT_BIT_15/ 0
#define IO_KEY_NEXT_N               0//KEY_PORTR_1    ///use witch port 做NEXT按键



///可选配置KEY_PORT_PR/KEY_PORT_DP/KEY_PORT_DM/KEY_POARA/KEY_POARA/KEY_POARB/KEY_POARC/KEY_POARD/ 0
#define IO_KEY_PREV_POART_SLECT     0//KEY_PORT_PR
///可选配置KEY_PORTR_0~KEY_PORTR_3/ PORT_BIT_0~PORT_BIT_15/ 0
#define IO_KEY_PREV_N               0//KEY_PORTR_0   ///use witch port 做PREV按键
...
#define USE_USB_IO_LED               LED_DM_TWO_LED

#define USE_PWM_CONTROL_LED          0       //用pwm推灯设置,用usb 的DM同时推两个灯R_LED, B_LED,只能用普通IO口推
...
#define AUTO_SHUT_DOWN_TIME          190//((3*60* 2)/2+10) //除以2 减去进低功耗的时间 概数
...
///<dac差分输出
#define DAC_DIFF_OUTPUT		 	     1

#if DAC_DIFF_OUTPUT
  #define DAC_DIFF_OUTPUT_NO_VCM		 1
#else

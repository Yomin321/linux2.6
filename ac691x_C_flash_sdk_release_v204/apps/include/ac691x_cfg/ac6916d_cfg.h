...
///可选配置KEY_PORT_PR/KEY_PORT_DP/KEY_PORT_DM/KEY_POARA/KEY_POARA/KEY_POARB/KEY_POARC/KEY_POARD/ 0
#define IO_KEY_NEXT_POART_SLECT     KEY_PORT_PR
//可选配置KEY_PORTR_0~KEY_PORTR_3/ PORT_BIT_0~PORT_BIT_15/ 0
#define IO_KEY_NEXT_N               KEY_PORTR_1    ///use witch port 做NEXT按键



///可选配置KEY_PORT_PR/KEY_PORT_DP/KEY_PORT_DM/KEY_POARA/KEY_POARA/KEY_POARB/KEY_POARC/KEY_POARD/ 0
#define IO_KEY_PREV_POART_SLECT     KEY_PORT_PR
///可选配置KEY_PORTR_0~KEY_PORTR_3/ PORT_BIT_0~PORT_BIT_15/ 0
#define IO_KEY_PREV_N               KEY_PORTR_0   ///use witch port 做PREV按键
...
#define LED_B_PORT_SLECT         LED_POARB
#define LED_B                    PORT_BIT_5 ///点蓝灯用第几个口

//可选配置 LED_POARA/LED_POARB/LED_POARC/LED_POARD
#define LED_R_PORT_SLECT         LED_POARB
#define LED_R                    PORT_BIT_4 ///点红灯用第几个口
